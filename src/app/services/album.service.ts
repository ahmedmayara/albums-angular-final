...
export class AlbumService {
  ...
  constructor(private http: HttpClient, private authService : AuthService) { this.albums = []; }
    ...
    addAlbum ( al:Album ): Observable<Album> {
      ...
      return this.http.post<Album>(this.apiURL + '/addAlbum', al, { headers: headers });
    }
    ...
    deleteAlbum ( id: number ) {
      ...
      token = "Bearer " + token;
      let headers = new HttpHeaders({'Authorization': token});
      return this.http.delete(this.apiURL + '/deleteAlbum/' + id, { headers: headers });
    }
    ...
    getAlbumById ( id : number ) : Observable<Album> {
      ...
      token = "Bearer " + token;
      let headers = new HttpHeaders({'Authorization': token});
      return this.http.get<Album>(this.apiURL + '/album/' + id, { headers: headers });
    }
    ...
    updateAlbum ( al:Album ): Observable<Album> {
      ...
      token = "Bearer " + token;
      let headers = new HttpHeaders({'Authorization': token});
      return this.http.put<Album>(this.apiURL + '/updateAlbum', al, { headers: headers });
    }
    ...
    rechrcheParLabel ( idLabel : number ) : Observable< Album[] > {
      ...
      token = "Bearer " + token;
      let headers = new HttpHeaders({'Authorization': token});
      return this.http.get<Album[]>(this.apiURL + '/label/' + idLabel, { headers: headers });
    }
